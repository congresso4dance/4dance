...
function getErrorMessage(error: unknown) {
  return error instanceof Error ? error.message : 'Erro inesperado no pagamento';
}
  ...
  return (
    <AnimatePresence>
      <div
        ...
        style={{ zIndex: 3000, background: 'rgba(0,0,0,0.92)', backdropFilter: 'blur(10px)' }}
        onClick={onClose}
      >
        <motion.div
        ...
        >
          <header
            ...
            style={{ borderBottom: '1px solid rgba(255,255,255,0.05)', padding: '1.5rem 2rem' }}
          >
            ...
            <button
              ...
              onClick={onClose}
              style={{ position: 'static', background: 'rgba(255,255,255,0.05)', borderRadius: '50%', padding: '6px' }}
            >
              <X size={20} />
            </button>
          </header>
          ...
          <div className={styles.checkoutBody} style={{ padding: '0' }}>
            <div style={{ padding: '1.5rem 2rem' }}>
              ...
              <div
                ...
                style={{ maxHeight: '40vh', overflowY: 'auto', marginBottom: '1.5rem', paddingRight: '0.5rem' }}
              >
                {items.length > 0 ? (
                  items.map((item) => (
                    <div
                    ...
                    >
                      ...
                      <div className={styles.cartItemInfo} style={{ flex: 1, marginLeft: '1rem' }}>
                        <span style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.5)', display: 'block' }}>
                          Foto HD #{item.id.slice(-6)}
                        </span>
              ...
              >
                <div
                  ...
                  style={{ marginBottom: '1.5rem', flexDirection: 'column', alignItems: 'flex-end', gap: '0.2rem' }}
                >
                  ...
                  >
                    ...
                    <strong style={{ fontSize: '1.75rem', fontWeight: 800, color: 'var(--primary)' }}>
                      R$ {total.toFixed(2)}
                    </strong>
                  </div>
                </div>
                ...
                <button
                  ...
                  style={{
                    ...
                    fontSize: '1rem',
                    fontWeight: 700,
                    background: isProcessing ? '#555' : 'var(--primary)',
                    boxShadow: isProcessing ? 'none' : '0 10px 20px -5px rgba(231, 31, 77, 0.4)',
                ...
                >
                  {isProcessing ? (
                    ...
                    <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                      Pagar R$ {total.toFixed(2)} <ChevronRight size={20} />
                    </span>
                  )}
                </button>
              </div>
